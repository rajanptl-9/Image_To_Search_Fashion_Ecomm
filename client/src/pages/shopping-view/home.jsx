...
import { IoFootstepsOutline,IoManOutline,IoWomanOutline   } from "react-icons/io5";


const categoriesWithIcon = [
  { id: "men", label: "Men", icon: IoManOutline },
  { id: "women", label: "Women", icon: IoWomanOutline },
  { id: "unisex", label: "Unisex", icon: TbArrowMergeBoth },
  { id: "accessories", label: "Accessories", icon: WatchIcon },
  { id: "footwear", label: "Footwear", icon: IoFootstepsOutline },
];
